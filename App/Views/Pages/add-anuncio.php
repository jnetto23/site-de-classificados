    ...
    <form id="form-add-ads" method='POST' enctype="multipart/form-data">
        ...
        <?php if(isset($_SESSION['msg'])):?>
            <?php
                ...
                unset($_SESSION['msg']);
            ?>
            <div class="alert alert-<?=$msg['class'];?> text-center">
                <?=$msg['msg'];?>
            </div>
        <?php endif;?>
        <div class="d-flex flex-wrap w-100">
            <div class="col-12 col-md-6 d-flex flex-column">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="title" placeholder="Titulo do Anúncio" autocomplete="off" required autofocus>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" type="text" name="desc" rows="3" placeholder="Insira uma breve descrição" autocomplete="off" required></textarea>
                </div>
                <div class="form-group">
                    <div class="form-row">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            ...
                            <input class="form-control text-right" name="value" type="text" maxlength="13" autocomplete="off" placeholder="0,00" required>       
                        </div>
                    </div>
                </div>
            </div>
