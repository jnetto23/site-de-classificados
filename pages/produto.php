                ...
                <div class="col-12 col-md-4">
                    <div id="carousel-imgs" class="carousel slide carousel-fade" data-ride="carousel">
                        <?php if(empty($ads['imgs'])):?>
                            <img class="d-block w-100" src="./assets/img/ads/default.png" alt="Default img">
                        <?php elseif(count(explode(',', $ads['imgs'])) === 1):?>
                            <img class="d-block w-100" src="./assets/img/ads/<?php echo $ads['imgs']?>" alt="<?php echo $ads['imgs']?>">
                        <?php else:?>
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="./assets/img/ads/<?php echo $ads['imgckd']?>" alt="<?php echo $ads['imgckd']?>">
                                </div>
                                <?php foreach(explode(',', $ads['imgs']) as $img): ?>
                                    <?php if($img !== $ads['imgckd']):?>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="./assets/img/ads/<?php echo $img?>" alt="<?php echo $img?>">
                                        </div>
                                    <?php endif; ?>
                                <?php endforeach; ?>
                            </div>
                ...
                <div class="col-12 col-md-8 d-flex flex-column">
                    <div class="ads-info d-flex flex-column h-100">
                        ...
                        <div class="d-block mb-3">
                            <a class="px-2 py-1 font-italic" style="background-color:#98c3f19c; border-radius:3px" href="#">
